...
export function setSecret(pluginOptions) {
    const handler = async (req)=>{
        ...
        if (user.hasTotp) {
            return Response.json({
                message: i18n.t('totpPlugin:errors:alreadySet'),
                ok: false
            });
        }
        ...
        if (typeof data !== 'object' || typeof data['token'] !== 'string' || typeof data['secret'] !== 'string') {
            return Response.json({
