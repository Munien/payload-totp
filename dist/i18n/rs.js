export const rs = {
    totpPlugin: {
        ...
        fieldDescription: 'Koristite aplikaciju za autentifikaciju ili proširenje pregledača da biste dobili kodove za dvofaktorsku autentifikaciju kada se to zatraži.',
        setup: {
