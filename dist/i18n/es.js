export const es = {
    totpPlugin: {
        ...
        fieldDescription: 'Utiliza una aplicación de autenticación o extensión del navegador para obtener códigos de autenticación de dos factores cuando se solicite.',
        setup: {
            ...
            enterCode: 'Ingresa el código de autenticación de {digits} dígitos generado por tu aplicación:',
