export const uk = {
    totpPlugin: {
        ...
        fieldDescription: 'Використовуйте додаток автентифікації або розширення браузера для отримання кодів двофакторної автентифікації за запитом.',
        setup: {
            addCodeManually: 'Додати код вручну',
            button: 'Налаштувати',
            description: 'Вам знадобиться додаток для двофакторної автентифікації, такий як <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" target="_blank" rel="nofollow noopener noreferrer">Google Authenticator</a>, щоб завершити цей процес. Після встановлення відскануйте QR-код нижче у ваш додаток.',
            enterCode: 'Введіть {digits}-значний код автентифікації, згенерований вашим додатком:',
